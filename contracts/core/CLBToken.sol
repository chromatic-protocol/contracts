...
contract CLBToken is ERC1155Supply, ICLBToken {
    ...
    function description(uint256 id) public view override returns (string memory) {
        return
            string(
                abi.encodePacked(_tokenSymbol(), " - ", _indexName(), " ", _humanReadableId(id))
            );
    }

    function image(uint256 id) public view override returns (string memory) {
        bytes memory humanReadableId = _humanReadableId(id);
        bytes memory color = "#6EC4F9";
        return
            string(
                abi.encodePacked(
                    "data:image/svg+xml;base64,",
                    Base64.encode(_svg(humanReadableId, _tokenSymbol(), _indexName(), color))
                )
            );
    }
    ...
    function _humanReadableId(uint256 id) private pure returns (bytes memory) {
        int16 tradingFeeRate = decodeId(id);
        uint256 absFeeRate = uint16(tradingFeeRate < 0 ? -(tradingFeeRate) : tradingFeeRate);
    ...
    function _svg(
        ...
        bytes memory gradientTags1 = _gradientTags1(stopTags);
        bytes memory gradientTags2 = _gradientTags2(stopTags);
        bytes memory gradientTags3 = _gradientTags3(stopTags);
        bytes memory gradientTags4 = _gradientTags4(stopTags);
        bytes memory headerTags = _headerTags(humanReadableId, symbol, index);
        bytes memory footerTags = _footerTags();
        ...
        return
            abi.encodePacked(
                ...
                '<g><rect width="480" height="480"/>',
                content,
                "</g></svg>"
            );
    }

    function _stopTags(bytes memory color) private pure returns (bytes memory) {
        return
            abi.encodePacked(
    ...
    function _gradientTags1(bytes memory stopTags) private pure returns (bytes memory) {
        return
            abi.encodePacked(
                ...
                stopTags,
                '</linearGradient><polygon style="fill:url(#SVGID_1_);" points="80,480 160,480 160,63.99 80,63.99"/>',
                ...
                stopTags,
                '</linearGradient><polygon style="fill:url(#SVGID_2_);" points="160,480 240,480 240,127.97 160,127.97"/>',
                ...
                stopTags,
                '</linearGradient><polygon style="fill:url(#SVGID_3_);" points="240,480 320,480 320,191.96 240,191.96"/>'
            );
    }

    function _gradientTags2(bytes memory stopTags) private pure returns (bytes memory) {
        return
            abi.encodePacked(
                ...
                stopTags,
                '</linearGradient><polygon style="fill:url(#SVGID_4_);" points="320,480 400,480 400,255.95 320,255.95"/>',
                ...
                stopTags,
                '</linearGradient><polygon style="fill:url(#SVGID_5_);" points="400,480 480,480 480,319.94 400,319.94"/>',
                '<linearGradient id="SVGID_6_" gradientUnits="userSpaceOnUse" x1="40" y1="480" x2="40" y2="0" gradientTransform="matrix(1 0 0 -1 0 480)">',
                stopTags,
                '</linearGradient><polygon style="fill:url(#SVGID_6_);" points="0,480 80,480 80,0 0,0"/>'
            );
    }

    function _gradientTags3(bytes memory stopTags) private pure returns (bytes memory) {
        return
            abi.encodePacked(
                ...
                stopTags,
                '</linearGradient><polygon style="fill:url(#SVGID_7_);" points="100,480 180,480 180,83.99 100,83.99"/>',
                ...
                stopTags,
                '</linearGradient><polygon style="fill:url(#SVGID_8_);" points="180,480 260,480 260,147.97 180,147.97"/>',
                ...
                stopTags,
                '</linearGradient><polygon style="fill:url(#SVGID_9_);" points="260,480 340,480 340,211.96 260,211.96"/>'
            );
    }

    function _gradientTags4(bytes memory stopTags) private pure returns (bytes memory) {
        return
            abi.encodePacked(
                ...
                stopTags,
                '</linearGradient><polygon style="fill:url(#SVGID_10_);" points="340,480 420,480 420,275.95 340,275.95"/>',
                ...
                stopTags,
                '</linearGradient><polygon style="fill:url(#SVGID_11_);" points="420,480 480,480 480,339.94 420,339.94"/>',
                '<linearGradient id="SVGID_12_" gradientUnits="userSpaceOnUse" x1="50" y1="460" x2="50" y2="0" gradientTransform="matrix(1 0 0 -1 0 480)">',
                stopTags,
                '</linearGradient><polygon style="fill:url(#SVGID_12_);" points="0,480 100,480 100,20 0,20"/>'
            );
    }

    function _headerTags(
        bytes memory humanReadableId,
        string memory symbol,
        string memory index
    ) private pure returns (bytes memory) {
        return
            abi.encodePacked(
                ...
                humanReadableId,
                "</text>",
                '<g><text transform="matrix(1 0 0 1 194.9673 146.5815)" style="fill:#FFFFFF; font-size:32px;">',
                symbol,
                " - ",
                index,
                "</text></g>"
    ...
    function _footerTags() private pure returns (bytes memory) {
        return
            abi.encodePacked(
                "<g>",
