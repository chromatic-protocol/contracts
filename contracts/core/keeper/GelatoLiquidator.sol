...
import {Module, ModuleData, IAutomate} from "@chromatic-protocol/contracts/core/base/gelato/Types.sol";

/**
 * @title Liquidator
 * @dev An abstract contract for liquidation functionality in the Chromatic protocol.
 */
abstract contract GelatoLiquidator is IChromaticLiquidator {
