 ...
 */
contract MockChromaticAccountV2 is IChromaticAccount, VerifyCallback {
    ...
    function initialize(
        ...
        contract_MockFlashloanV2 = MockFlashloanV2(_flashloanContract);
    }
    ...
    function addLiquidity(address _marketAddress) public {
        IChromaticMarket(_marketAddress).addLiquidity(address(this), int16(1), "");
    }
    ...
    function addLiquidityCallback(
        ...
        contract_MockFlashloanV2.flashloan(settlementToken, 3000e18);
    }
